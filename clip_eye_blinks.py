...
output_dir_au47 = base_path + "CleanAnEquinePainFaceDataset/AU_47_Clips"
output_dir_au145 = base_path + "CleanAnEquinePainFaceDataset/AU_145_Clips"
output_dir_au143 = base_path + "CleanAnEquinePainFaceDataset/AU_143_Clips"
    ...
    for video in list_video_names:
        for action_unit in video_data[video]:
            ...
            if 'AU47' in code:
                ...
                subprocess.run(["ffmpeg", "-y", "-ss", action_start, "-i", input_file_path, "-c", "copy", "-t", duration, f"{output_dir_au47}/clip_{i_au47}_{code}_{video}"])
                i_au47 = i_au47 + 1
            ...
            if 'AU145' in code:
                ...
                subprocess.run(["ffmpeg", "-y", "-ss", action_start, "-i", input_file_path, "-c", "copy", "-t", duration, f"{output_dir_au145}/clip_{i_au145}_{code}_{video}"])
                i_au145 = i_au145 + 1
            ...
            if 'AU143' in code:
                ...
                subprocess.run(["ffmpeg", "-y", "-ss", action_start, "-i", input_file_path, "-c", "copy", "-t", duration, f"{output_dir_au143}/clip_{i_au143}_{code}_{video}"])
                i_au143 = i_au143 + 1
