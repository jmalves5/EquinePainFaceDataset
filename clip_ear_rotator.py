...
videos_path = base_path + "CleanAnEquinePainFaceDataset/videos/cropped_videos/"
annotations_file_path = base_path + "CleanAnEquinePainFaceDataset/JSONAnnotations/annotations.json" 
FPS=25

# Create output folder
output_dir = base_path + "CleanAnEquinePainFaceDataset/EAD_104_Clips/cropped_EAD_104_Clips"
